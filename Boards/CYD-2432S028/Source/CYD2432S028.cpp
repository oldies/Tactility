...
#include "hal/CYD2432S028Display.h"
#include "hal/CYD2432S028DisplayConstants.h"
...
extern const Configuration cyd_2432s028_config = {
    .initBoot = initBoot,
    ...
    spi {
        ...
        spi::Configuration {
            ...
            .dma = SPI_DMA_DISABLED,
            .config = {
                .mosi_io_num = GPIO_NUM_32, //GPIO_NUM_23,
                .miso_io_num = GPIO_NUM_39, //GPIO_NUM_19,
                .sclk_io_num = GPIO_NUM_25, //GPIO_NUM_18,
                .quadwp_io_num = GPIO_NUM_NC,
                .quadhd_io_num = GPIO_NUM_NC,
                .data4_io_num = GPIO_NUM_NC,
                .data5_io_num = GPIO_NUM_NC,
                ...
                .data7_io_num = GPIO_NUM_NC,
                .data_io_default_level = false,
                .max_transfer_sz = CROWPANEL_SPI_TRANSFER_SIZE_LIMIT, //32768,
                .flags = 0,
                .isr_cpu_id = ESP_INTR_CPU_AFFINITY_AUTO,
                .intr_flags = 0
            },
